...
function getRocketChatConfig(cfg: ClawdbotConfig): Record<string, unknown> | undefined {
  return (cfg as Record<string, unknown>).channels?.rocketchat;
}

export function listRocketChatAccountIds(cfg: ClawdbotConfig): string[] {
...
export function resolveDefaultRocketChatAccountId(cfg: ClawdbotConfig): string {
