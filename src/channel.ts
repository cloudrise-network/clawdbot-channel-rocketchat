...
function looksLikeRocketChatTargetId(value: string): boolean {
  ...
  // Clawdbot/OpenClaw may hand the channel a destination like "rocketchat:<rid>"
...
function normalizeRocketChatMessagingTarget(raw: string): string {
  ...
  // Normalize prefixed targets to Rocket.Chat canonical forms.
  ...
  security: {
    resolveDmPolicy: ({ cfg, accountId, account }) => {
      ...
      return {
        ...
        approveHint: `clawdbot pairing approve rocketchat <code>`,
